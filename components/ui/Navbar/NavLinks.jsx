            ...
            {link.submenu && (
              <div>
                <div className="absolute  top-10 hidden hover:md:block group-hover:md:block">
                  ...
                  <div className="grid grid-cols-3 gap-2 bg-white shadow-lg rounded-lg p-5">
                    {link.sublinks.map((mysublinks) => (
                      <div key={index}>
                        <h1 className="text-lg font-semibold bg-gray-100 px-2 py-1 rounded-lg">
                          {mysublinks.Head}
                        </h1>
                        {mysublinks.sublink.map((slink) => (
                          <li className="my-2.5 pr-2 text-sm text-gray-600 transition-all duration-150 ease-out hover:text-black hover:font-bold">
              ...
              <div key={index}>
                <div>
                  <h1
                    ...
                    className="flex items-center bg-red-400 justify-between py-4 pl-7 pr-5  font-semibold  md:pr-0"
                  >
                    {slinks.Head}
